...
/**
 * Created by jdry on 2016/9/9. jdry 工具类
 */
public class JdryTime {
	...
	public static String getFormatDate(long sec, String format) {
		SimpleDateFormat ymdhms2 = new SimpleDateFormat(format);
		Date d = new Date(sec);
		return ymdhms2.format(d);
	}
