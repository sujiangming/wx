...
<script src="${ContextPath}/pages/timeordercount/timeCount.js"
	type="text/javascript"></script>
							...
							<fieldset id="customerInfo">
								...
								<div class="form-group form-group-sm ">
									...
									<div class="col-sm-6">
										...
										<!-- 到 <input class="form-control validate[required]" id="orderTime2"
											type="text" /><span style="color:#ccc;">例：10:00</span> -->
									</div>
								</div>
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
