...
<script src="${ContextPath}/pages/timeordercount/timeordercount.js"
	type="text/javascript"></script>
<style type="text/css">
							...
							<fieldset id="customerInfo">
								...
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										...
										预约日期</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="orderDate"
											type="date" />
									</div>
								</div>
								<div class="form-group form-group-sm ">
									...
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="orderTime"
											type="text" /><span style="color: #ccc;">例：9:00-10:00</span><br>
									</div>
								</div>
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										...
										预约人数</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="orderCount"
											type="text" />
									</div>
								</div>
								...
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										style="color: red; position: relative; top: 2px;">*</span> 检车站</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="carType"
											type="text" value="${loginUser.checkStationName}" />
									</div>
								</div>
