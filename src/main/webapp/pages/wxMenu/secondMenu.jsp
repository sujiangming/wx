...
<%@page import="com.bj.scb.weixin.FirstMenu"%>
<%@page import="java.util.List"%>
<%@page import="com.bj.scb.weixin.Util"%>
...
<%
	...
	List<FirstMenu> menus = Util.menu.getButton();
...
<title>微信自定义菜单-二级菜单</title>
<%@ include file="/common/taglibs.jsp"%>
<link href="${ContextPath}/UI-lib/plugins/fileinput/fileinput.min.css"
	rel="stylesheet" />
<script src="${ContextPath}/pages/wxMenu/secondMenu.js"
			...
			<div class="modal-dialog" style="width: 800px">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalTitle">新增二级菜单信息</h4>
					</div>
							...
							<fieldset id="customerInfo">
								...
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										...
										父菜单名称</label>
									<div class="col-sm-6">
										<select id="parentMenuName" width=100%>
											<option value="">--请选择--</option>
											<c:forEach items="${requestScope.menus}" var="menu">
												<c:if test="${'click' eq menu.type}">
								...
								<div id="urlDiv" class="form-group form-group-sm " style="display: none;">
									<label class="col-sm-2 control-label"><span
										...
										菜单Url</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="secondMenuUrl"
											type="text" />
									</div>
								</div>
								<br>
					...
					<input class="form-control" id="menu" type="hidden" value="${menus}"/>
				</div>
			</div>
		</div>
		<!-- 弹出窗口区域，触发事件后弹出   结束 -->
