...
<script src="${ContextPath}/pages/comment/comment.js" type="text/javascript"></script>
<style type="text/css">
    ...
    <div class="wrapper wrapper-content">
		...
		<!-- 弹出窗口区域，触发事件后弹出  --> 
		 ...
		 <div class="modal-body">
          			<form id="myForm1" class="form-horizontal" role="form">
						...
						<legend style="font-size:15px;border:0;"></legend>
							   ...
							   <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;display:none;">*</span> 评价人ID</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="name" type="text" />
									  </div>
							   </div>
							    <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 评价人姓名</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="name" type="text" />
									  </div>
							   </div>
							   <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 评价分数</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="name" type="text" />
									  </div>
							   </div>
							   <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 评价时间</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="name" type="text" />
									  </div>
							   </div>
			    ...
			    <!-- <input class="form-control" id="id" type="hidden" style="display: none;" /> -->
          		</div>
          		</div>
	 		</div>
		 	<!-- 弹出窗口区域，触发事件后弹出   结束 -->
