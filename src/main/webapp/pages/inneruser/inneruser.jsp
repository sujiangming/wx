...
<script src="${ContextPath}/pages/inneruser/inneruser.js" type="text/javascript"></script>
<style type="text/css">
          			...
          			<form id="myForm1" class="form-horizontal" role="form">
						...
						<legend style="font-size:15px;border:0;"></legend>
							 ...
							 <!--   <div class="form-group form-group-sm ">
									  ...
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="innerUserId" type="text" />
									  </div>
							   </div> -->
							    <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 头像</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="innerUserPic" type="text" />
							   ...
							   <div class="form-group form-group-sm ">
									  ...
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="innerUserGender" type="text" />
									  </div>
							   </div>
							   <div class="form-group form-group-sm ">
							   ...
							   <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 所属检查站</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="checkStationName" type="text" />
									  </div>
							   </div>
