...
<script src="${ContextPath}/pages/emergency/emergencyOrder.js"
	type="text/javascript"></script>
<style type="text/css">
			...
			<div class="modal-dialog" style="width: 800px">
				<div class="modal-content">
							...
							<fieldset id="customerInfo">
								...
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										...
										定金</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="payFee"
											type="text" />
									</div>
								</div>
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										...
										总价</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="sumPrice"
											type="text" />
									</div>
								</div>
								<div class="form-group form-group-sm ">
					...
					<div class="modal-footer">
						...
						<button id="btEmpAdd" onclick="sendOrder()"
							class="btn btn-primary" type="button">派单</button>
					</div>
					<input class="form-control" id="id" type="hidden" />
					<input class="form-control" id="isManager" type="hidden" value="${isManager}"/>
				</div>
			</div>
		</div>
		<!-- 弹出窗口区域，触发事件后弹出   结束 -->
