...
<script src="${ContextPath}/pages/emergency/emergencyprive.js" type="text/javascript"></script>
<style type="text/css">
    ...
    <div class="wrapper wrapper-content">
		...
		<!-- 弹出窗口区域，触发事件后弹出  --> 
		 ...
		 <div class="modal-header">
							...
							<h4 class="modal-title" id="myModalTitle">新增(编辑)车型单价资料</h4>
		 </div>
          			...
          			<form id="myForm1" class="form-horizontal" role="form">
						...
						<legend style="font-size:15px;border:0;"></legend>
							   ...
							   <div class="form-group form-group-sm " style="display:none">
									  ...
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="name" type="text" />
									  </div>
							   </div>
							    <div class="form-group form-group-sm " style="display:none">
							    	  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 车型描述</label>
									  <div class="col-sm-6">
									  	<textarea class="form-control validate[required]" id="type"></textarea>
									  </div>	
							   </div>
							   ...
							   <div class="form-group form-group-sm ">
									  <label class="col-sm-2 control-label"><span style="color:red;position:relative;top:2px;">*</span> 单价</label>
									  <div class="col-sm-6">
											<input class="form-control validate[required]" id="unitPrice" type="text" />
									  </div>
							   </div>
							   <br>
						  </fieldset>
