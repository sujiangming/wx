...
<body style="background: #376B6D" class="">
	...
	<div
		...
		<div
			...
			<p class="text-muted"
				style="color: #FDFBF3; font-size: 25px; font-family: Microsoft YaHei; line-height: 77px;">快捷审车帮管理平台</p>
		</div>
	</div>
		...
		function doLogin() {
			...
			$.ajax({
						...
						success : function(data) {
							if (data.status == "1") {
								location.href = "${ContextPath}/system/main/mainFrame.jsp"
							} else {
		 ...
		 $(document).ready(function (e) {
		        ...
		        if (window.history && window.history.pushState) {
		            $(window).on('popstate', function () {
		                ...
		                self.location=getRootPath()+"login/login.jsp";; //如查需要跳转页面就用它
		            });
		        }
