...
<script type="text/javascript"
	src="${ContextPath}/system/role/roleMaintain.js"></script>
</head>
<body class="gray-bg">
		...
		<div
			...
			<div class="row">
				<div class="col-md-6" style="float: left; margin-top: 10px;"
					...
					<button id="btn_del" class="btn btn-primary" disabled type="button">
								...
								<form id="myForm1" class="form-horizontal" role="form">
									...
									<fieldset id="basicInfo">
										...
										<!-- <div class="form-group form-group-sm ">
											...
											<div class="col-sm-10">
												<input class="form-control" id="roleType" type="text" />
											</div>
										</div> -->
										<br>
									</fieldset>
